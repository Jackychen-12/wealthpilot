...
| 层 | 技术 |
|----|------|
| Frontend | Vite 6, React 18, TypeScript 5.6, SSE Streaming |
...
| **AI 对话** | 多 Agent 路由 + 多轮对话 + SSE 流式 + 工具调用可视化 | Claude/DeepSeek + 实时市场数据 |
